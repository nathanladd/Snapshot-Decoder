...
in order to determine what type of Snapshot file has been opened and pull any general machine information from the 
Snapshot header. Snapshot Decoder can then read-in all frames of all PIDs in the Snapshot delineated file and store 
...
on troubleshooting success for common diagnostic tasks available at a click of a button.
