"""Background QThread that checks GitHub Releases for a newer Snapshot Decoder version.
...
_RELEASES_URL = "https://api.github.com/repos/nathanladd/Snapshot-Decoder/releases/latest"
_SHA256_RE = re.compile(r"sha256[:\s]+([0-9a-f]{64})", re.IGNORECASE)


class UpdateChecker(QThread):
    update_available = Signal(str, str, str, str)  # version, notes, download_url, sha256
    up_to_date = Signal()
