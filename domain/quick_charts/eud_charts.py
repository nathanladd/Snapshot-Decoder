...
# Uses that definition to build and display the bubble chart

EUD_CHARTS: dict[str, QuickChartDef] = {
    "V1EUD_SPEED_V_LOAD": V1EUD_SPEED_V_LOAD, #Speed vs Load Bubble Chart
    "V1EUD_SPEED_BAND": V1EUD_SPEED_BAND,     #Speed Band Run Time Bar Chart
    "V1EUD_ELEVATION": V1EUD_ELEVATION,       #Time at Elevation Bar Chart
    "V1EUD_EGT": V1EUD_EGT,                   #Time at EGT Bar Chart
}
